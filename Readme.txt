...
Model Selection:
Upon execution, the CLI will prompt you to select the desired model. Simply type the number corresponding to the model you want to evaluate and press Enter.
