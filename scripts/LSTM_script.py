...
# Load the model
selected_model = input("Choose LSTM model (1 for model trained on data 'city_day.csv', 2 for model trained on data 'taiwan2015.csv'): ")
true_value_dict = {}

if selected_model == '1':
    model_path = 'SAVED_MODEL/LSTM_model_city_day.h5'
    ...
    model_path = 'SAVED_MODEL/LSTM_model_taiwan.h5'
...
def main():
    ...
    user_input = input("Would you like to continue evaluating with the current script - LSTM ? (yes/no): ")
